      ...
      <div className="relative aspect-video w-full overflow-hidden bg-brand-primary/5">
        ...
        {featuredProject && (
          <div className="absolute bottom-4 left-4 right-4 flex">
            <div className="bg-bg-white/95 backdrop-blur-sm px-3 py-1.5 rounded-full text-xs font-semibold text-brand-primary shadow-sm border border-black/5 flex items-center gap-2">
